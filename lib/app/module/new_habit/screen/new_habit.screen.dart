...
class NewHabitScreen extends ConsumerWidget {
  late final AutoDisposeNotifierProvider<NewHabitScreenViewModel,
      NewHabitScreenModel> newHabitScreenProvider;
      ...
      children: colors
          ...
          .map((i) => Padding(
                ...
                child: GestureDetector(
                  ...
                  child: ColorPick(
                      color: Constant.colorPalettes[i],
